...
export default function Home() {
  return (
    <div>
      ...
      <motion.div initial={{ opacity: 0, x: -200 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1.5 }} whileInView={{ opacity: 1, x: 0 }} className="absolute inset-0  flex items-center justify-center text-white md:text-4xl text-2xl font-bold md:ml-0 text-center -mt-32">
        ¡Bienvenido a nuestro taller García Hnos!
      </motion.div>
      <motion.div initial={{ opacity: 0, x: -200 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1.5 }} whileInView={{ opacity: 1, x: 0 }} className="absolute inset-0  flex items-center justify-center text-white md:text-2xl text-lg font-bold md:ml-0 text-center md:mt-1 mt-20 p-3">
